...
abstract contract OwnableRoles is Ownable {
    ...
    uint256 internal constant _ROLE_0 = 1 << 0; // Factory
    uint256 internal constant _ROLE_1 = 1 << 1; // PositionManager
    uint256 internal constant _ROLE_2 = 1 << 2; // Configurator
    ...
    uint256 internal constant _ROLE_42 = 1 << 42; // YieldOptimizer Keeper
